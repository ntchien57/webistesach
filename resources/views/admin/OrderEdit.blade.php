...
<div class="container box">
    ...
    <div>
       <table class="table box table-bordered">
        ...
        <tr>
          <th>Ghi chú:</th><td><a href="#" class="updateInfoRequired" data-name="address2" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("order_update") }}" data-title="Địa chỉ 2" >{{ $order->comment }}</a></td>
        </tr>
