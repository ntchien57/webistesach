...
{{--                 <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
              ...
              <span class="editable" itemprop="sku">{{ $product->sku }}</span>
                <p class="availability in-stock pull-right">Trạng thái: <span style="color:green">Còn hàng</span>
...
{{--               <div class="product-color-size-area">
              ...
              <form id="buy_block" action="{{ action('Shop@cart') }}" method="post">
                ...
                <input type="hidden" name="product_id" value="{{ $product->id }}" />
                  ...
                  <button class="button pro-add-to-cart" title="Add to Cart" type="submit"><span><i class="fa fa-shopping-basket"></i> 
              ...
              <div class="share-box">
                <div class="fb-like" data-href="{{ url('san-pham/'.ktc_str_convert($product->name).'_'.$product->id.'.html') }}" data-layout="button_count" 
