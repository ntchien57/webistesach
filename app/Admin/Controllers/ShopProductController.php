    ...
    protected function form($id = null)
    {
        ...
        return Admin::form(ShopProduct::class, function (Form $form) use ($id) {
            $form->tab('Thông tin sản phẩm', function ($form) {
                ...
                // $form->text('capacity', 'Dung tích');
                // $form->text('skin_form', 'Loại da');
                // $form->text('product_form', 'Dạng sản phẩm');
                // $form->text('youtube_url', 'Đường dẫn Youtube');
                // $form->text('origin', 'Nguồn gốc');
                // $form->text('product_code', 'Mã sản phẩm');
                // $form->text('material', 'Chất liệu');
                // $form->text('pattern', 'Họa tiết');
                // $form->textarea('product_note', 'Ghi chú');
                ...
                // $form->textarea('description_en', 'Mô tả (Tiếng Anh)')->rules('max:300', ['max' => 'Max length is 300']);
                // $form->ckeditor('special_promotion', 'Đặc biệt');
                $form->ckeditor('content', 'Nội dung');
                // $form->ckeditor('content_en', 'Nội dung (Tiếng Anh)');
                // $form->number('allowed_amount', 'Số lượng tối đa được mua trên mỗi đơn hàng');
